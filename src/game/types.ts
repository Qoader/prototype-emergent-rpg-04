...
export type Settlement = Point & { id: string; name: string; kind: SettlementKind; countryId: string; radius: number; bounds: { left: number; top: number; right: number; bottom: number }; entrances: Point[] };
